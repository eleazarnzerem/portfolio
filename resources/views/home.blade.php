    ...
    <main class="max-w-7xl mx-auto" x-data="{ playing: false, showModal: false, src: null }">
        <section class="mx-auto py-10 px-11 space-y-7">
            ...
            <div class="w-full bg-[#161616] rounded-lg px-2 pb-9">
                <p class="text-[#e9bc5b] font-bold text-2xl text-center py-3">SHORT FORM</p>
                <div class="grid md:grid-cols-2 lg:grid-cols-3 mt-10 px-16 gap-4 gap-y-9 w-4/5 mx-auto">

                    <div class="w-[250px] h-[350px] bg-red-200 rounded-lg relative overflow-hidden group"
                        @mouseenter="playHoverVideo($refs.video)" @mouseleave="stopHoverVideo($refs.video1)"
                        @click="showModal = true, src = `{{ asset('video/short2.mp4') }} `">
                        ...
                        <!-- Click to Open Modal -->
                        <div @click="openModal($refs.modalVideo, $refs.video1)" class="absolute inset-0 cursor-pointer">
                        </div>
                    </div>

                    <div class="w-[250px] h-[350px] bg-red-200 rounded-lg relative overflow-hidden group"
                        @mouseenter="playHoverVideo($refs.video)" @mouseleave="stopHoverVideo($refs.video2)"
                        ...
                        <!-- Click to Open Modal -->
                        <div @click="openModal($refs.modalVideo, $refs.video2)" class="absolute inset-0 cursor-pointer">
                        </div>
                    </div>
                    <div class="w-[250px] h-[350px] bg-red-200 rounded-lg relative overflow-hidden group"
